...
wb=addUsage(wb,{fn:'function O_y(e){const t=Hfp(119)',jsx:'M0t',
  original:'title:"Plan & Usage",children:[yn,an,Kt,xn]',
  claudeOnly:'title:"Plan & Usage",children:[yn,an,Kt,xn,M0t(__claudeUsageSection,{})]',
  symbols:{jsx:'M0t',useState:'Klr',useEffect:'avp',card:'Jb',zs:'zs',bar:'EA',barStyle:'tur'}});
...
glass=addUsage(glass,{fn:'function hH1(t){const e=sDg(119)',jsx:'cH1',
  original:'title:"Plan & Usage",children:[ft,wt,gt,Tt]',
  claudeOnly:'title:"Plan & Usage",children:[ft,wt,gt,Tt,cH1(__claudeUsageSection,{})]',
  symbols:{jsx:'cH1',useState:'vgr',useEffect:'dfd',card:'Yf',zs:'Ks',bar:'Im',barStyle:'mTi'}});
